# LLMAgent.py
#
# This module represents the Large-Language-Model (LLM) agent for Rock-Paper-Scissors.
# The LLM agent will try to predict the opponent's next move based on their last few moves
# and then counter that move.
