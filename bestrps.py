...
def bestrps_move(input=""):
    ...
    predictors = [return]*num_predictor
if input != "":
    #update predictors
    #"""
    ...
    for i in range(3):
        temp =""
        search = temp1[(return+input)] #last round
    ...
    return = random.choice(not_lose[predict])
